...
export default function CartDrawer({ isOpen, onClose, cart, menuData, onUpdateQuantity, onRemoveItem, onConfirmOrder }) {
                ...
                {cartItems.length > 0 && (
                    <div className="border-t border-gray-200 p-4 space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3 px-4 rounded-lg font-medium text-gray-800 transition-colors hover:opacity-90"
                            style={{ backgroundColor: 'var(--cozy-lemon)' }}
                        >
                            Confirm Order ({totals.totalItems} {totals.totalItems === 1 ? 'item' : 'items'})
                        </button>
                    </div>
                )}
            </div>
